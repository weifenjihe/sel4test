...
static bool net_device_emul_io_in(struct virtio_emul *emul, unsigned int offset,
...
static bool net_device_emul_io_out(struct virtio_emul *emul, unsigned int offset,
